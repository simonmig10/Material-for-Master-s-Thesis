...
IF> date >= 1990 & Weak_PH > 0 & carbon_tax_brown <= 0
IDENTITY> inv_gr_rd_brown
EQ> LOG(inv_gr_rd_brown) = -1.03 + LOG(inv_brown) + 0.15*LOG(carbon_tax_brown)
IF> date >= 1990 & Weak_PH > 0 & carbon_tax_brown > 0 
IDENTITY> inv_gr_rd_brown
...
COMMENT> *(1 - ad_exp*TSLAG(d_t_brown,1))
IDENTITY> x_brown
EQ> LOG(x_brown) = eps0 - eps1*LOG(TSLAG(xr_brown,1)) + eps2*LOG(y_green)
IF> Strong_PH <= 0
IDENTITY> x_brown
EQ> LOG(x_brown) = -5.93 - eps1*LOG(TSLAG(xr_brown,1)) + eps2*LOG(y_green) + 0.05*LOG(eta_gr_brown)
IF> Strong_PH > 0
...
IF> Strong_PH <= 0
IDENTITY> im_brown
EQ> LOG(im_brown) = -0.29 + mu1*LOG(TSLAG(xr_brown,1)) + mu2*LOG(y_brown) + 0.05*LOG(eta_gr_green)
IF> Strong_PH > 0
...
IF> Narrowly_strong_PH  <= 0 & disc_1 <= 0
IDENTITY> x_gr_brown
EQ> x_gr_brown = exp(3.4+ eps_gr1*log(x_brown)+1*log(carbon_tax_x_brown))
IF> Narrowly_strong_PH  <= 0 & disc_1 > 0
IDENTITY> x_gr_brown
EQ> x_gr_brown = (exp(-2.25+ eps_gr1*log(x_brown) + 0.5*log(eta_gr_brown)))
IF> Narrowly_strong_PH  > 0 & disc_1 <= 0
IDENTITY> x_gr_brown
EQ> x_gr_brown = exp(-2.25+ eps_gr1*log(x_brown) + 0.5*log(eta_gr_brown) + 1*log(carbon_tax_x_brown))
IF> Narrowly_strong_PH  > 0 & disc_1 > 0
...
IDENTITY> im_gr_brown
EQ> im_gr_brown = (exp(-2.25+ eps_gr1*log(im_brown) + 0.5*log(eta_gr_green)))
IF> Narrowly_strong_PH  > 0
...
inv_gr_rd_brown_30/inv_brown_30
...
inv_gr_rd_brown_11/inv_brown_11
...
window(inv_gr_rd_brown_12/inv_brown_12, start=2024)
...
window(inv_gr_rd_brown_13/inv_brown_13, start= 2024)
## Stability check
...
inv_gr_rd_brown_14/inv_brown_14
## Stability check
...
plot((emis_brown_11-emis_brown_10)/emis_brown_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission Denmark", ylim= c(-50,1), lwd= 2);
...
plot((emis_green_11-emis_green_10)/emis_green_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission ROW", ylim= c(-0.11,0.01), lwd= 2);
