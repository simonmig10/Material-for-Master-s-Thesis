...
COMMENT> 
IDENTITY> x_brown_no_s
EQ> LOG(x_brown_no_s) = eps0 - eps1*LOG(TSLAG(xr_brown,1)) + eps2*LOG(y_green)
...
IF> Narrowly_strong_PH  <= 0 & Strong_PH <= 0
IDENTITY> x_gr_brown
EQ> x_gr_brown = exp(-2.25+ eps_gr1*log(x_brown) + 0.5*log(eta_gr_brown))
IF> Narrowly_strong_PH  > 0 & Strong_PH <= 0
IDENTITY> x_gr_brown
EQ> x_gr_brown = exp(-2.25+ eps_gr1*log(x_brown_no_s) + 0.5*log(eta_gr_brown)) 
IF> Narrowly_strong_PH  > 0 & Strong_PH > 0
...
plot((eta_green_11- eta_green_10)/eta_green_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share ROW", ylim= c(0, 0.025), lwd= 2);
...
plot((emis_green_11-emis_green_10)/emis_green_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission ROW", ylim= c(-0.04,0.01), lwd= 2);
