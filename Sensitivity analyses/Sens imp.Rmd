...
Gør at 4. scenario har samme effekt som i 3. scenario
...
EQ> beta_im_gr_brown = k_gr_im_new_brown/k_gr_im_brown*beta_gr_green + imp_brown*(k_gr_im_brown - k_gr_im_new_brown) /k_gr_im_brown*TSLAG(beta_im_gr_brown,1) + (1-imp_brown)*((k_gr_im_brown - k_gr_im_new_brown)/k_gr_im_brown)*beta_gr_green


COMMENT> 
IDENTITY> eta_im_gr_brown
EQ> eta_im_gr_brown = k_gr_im_new_brown/k_gr_im_brown*eta_gr_green + imp_brown*(k_gr_im_brown - k_gr_im_new_brown) /k_gr_im_brown*TSLAG(eta_im_gr_brown,1) + (1-imp_brown)*((k_gr_im_brown - k_gr_im_new_brown)/k_gr_im_brown)*eta_gr_green
...
EQ> beta_im_gr_green = k_gr_im_new_green/k_gr_im_green*beta_gr_brown + imp_green*(k_gr_im_green - k_gr_im_new_green) /k_gr_im_green*TSLAG(beta_im_gr_green,1) + (1-imp_green)*((k_gr_im_green - k_gr_im_new_green)/k_gr_im_green)*beta_gr_brown


COMMENT> 
IDENTITY> eta_im_gr_green
EQ> eta_im_gr_green = k_gr_im_new_green/k_gr_im_green*eta_gr_brown + imp_green*(k_gr_im_green - k_gr_im_new_green) /k_gr_im_green*TSLAG(eta_im_gr_green,1) + (1-imp_green)*((k_gr_im_green - k_gr_im_new_green)/k_gr_im_green)*eta_gr_brown
...
x_brown = im_green; S_modelData$x_brown = x_brown
x_brown_no_s = x_brown; S_modelData$x_brown_no_s = x_brown_no_s#New export for strong PH
...
wa_brown = TIMESERIES(rep(11/2,101), START = c(1960,1)); S_modelData$wa_brown = wa_brown #Waste generated by production activities (Gt)  
wa_green = TIMESERIES(rep(11/2,101), START = c(1960,1)); S_modelData$wa_green = wa_green #Waste generated by production activities (Gt)  
...
res_e_brown = TIMESERIES(rep(271000*(1-sigma_e_brown[1])^(-64),101), START = c(1960,1)); S_modelData$res_e_brown = res_e_brown
res_e_green = TIMESERIES(rep(271000*(1-sigma_e_green[1])^(-64),101), START = c(1960,1)); S_modelData$res_e_green = res_e_green #Initial value of non-renewable energy resources of Greenland (Ej) 
...
res_m_brown = 195000*(1-sigma_m_brown)^(-64); S_modelData$res_m_brown = res_m_brown #Initial value of matter resources of Brownland (Gt) - Note: 64 is the number of periods from 1951 to 2015 
res_m_green = 195000*(1-sigma_m_green)^(-64); S_modelData$res_m_green = res_m_green #Initial value of matter resources of Greenland (Gt) 
...
sens_imp= TIMESERIES(rep(0,101), START = c(1960,1));S_modelData$sens_imp = sens_imp
Strong_PH= TIMESERIES(rep(0,101), START = c(1960,1));S_modelData$Strong_PH = Strong_PH
disc_1= TIMESERIES(rep(0,101), START = c(1960,1));S_modelData$disc_1 = disc_1
...
plot((eta_brown_11 - eta_brown_10)/eta_brown_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share DK", ylim=c(0,12), lwd= 2);
...
plot((eta_green_11- eta_green_10)/eta_green_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share ROW", ylim= c(0, 0.05), lwd= 2);
...
plot((emis_green_11-emis_green_10)/emis_green_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission ROW", ylim= c(-0.08,0.01), lwd= 2);
