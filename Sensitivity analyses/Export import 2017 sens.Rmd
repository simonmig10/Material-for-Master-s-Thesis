...
COMMENT> 
IDENTITY> x_brown
EQ> LOG(x_brown) = -5.6802 - eps1*LOG(TSLAG(xr_brown,1)) + eps2*LOG(y_green)
IF> Strong_PH <= 0
IDENTITY> x_brown
EQ> LOG(x_brown) = -5.531  - eps1*LOG(TSLAG(xr_brown,1)) + eps2*LOG(y_green) + 0.05*LOG(eta_gr_brown)
IF> Strong_PH > 0 
...
IDENTITY> im_brown
EQ> LOG(im_brown) = -0.35 + mu1*LOG(TSLAG(xr_brown,1)) + mu2*LOG(y_brown)
IF> Strong_PH <= 0
IDENTITY> im_brown
EQ> LOG(im_brown) = -0.2 + mu1*LOG(TSLAG(xr_brown,1)) + mu2*LOG(y_brown) + 0.05*LOG(eta_gr_green)
IF> Strong_PH > 0
...
alpha1_w_brown = TIMESERIES(rep(0.690919,101), START = c(1960, 1)); S_modelData$alpha1_w_brown = alpha1_w_brown
alpha1_r_brown = TIMESERIES(rep(0.490919,101), START = c(1960, 1)) ; S_modelData$alpha1_r_brown = alpha1_r_brown# ændert
alpha1_w_green = TIMESERIES(rep(0.750919,101), START = c(1960, 1)) ; S_modelData$alpha1_w_green = alpha1_w_green
...
plot((eta_brown_11 - eta_brown_10)/eta_brown_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share DK", ylim=c(0,15), lwd= 2);
...
plot((eta_green_11- eta_green_10)/eta_green_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share ROW", ylim= c(0, 0.06), lwd= 2);
...
plot((emis_green_11-emis_green_10)/emis_green_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission ROW", ylim= c(-0.07,0.01), lwd= 2);
