...
gov_gr_ob= ifelse(window(date,end=2017)<1990,0,0.05*gov_ob); S_modelData$gov_gr_ob = gov_gr_ob 
...
par(mfrow=c(2,2))
plot((y_green_10), col= "black", xlab= "Year", ylab= "Level", main= "GDP ROW", ylim= c(0,150), lwd= 2);
lines((y_green_20), col= "red", lwd= 2);
lines((y_green_30), col= "blue", lwd= 2);
lines((y_green_40), col= "purple4", lwd= 2);
lines((y_green), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()

plot((y_brown_10), col= "black", xlab= "Year", ylab= "Level", main= "GDP DK", ylim=c(0,0.6), lwd= 2);
lines((y_brown_20), col= "red", lwd= 2);
lines((y_brown_30), col= "blue", lwd= 2);
lines((y_brown_40), col= "purple4", lwd= 2);
lines((y_brown), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()

plot((emis_green_10), col= "black", xlab= "Year", ylab= "Level", main= "Emission ROW", ylim= c(0,50), lwd= 2);
lines((emis_green_20), col= "red", lwd= 2);
lines((emis_green_30), col= "blue", lwd= 2);
lines((emis_green_40), col= "purple4", lwd= 2);
lines((emis_green), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()

plot((emis_brown_10), col= "black", xlab= "Year", ylab= "Level", main= "Emission DK", ylim=c(0,0.2), lwd= 2);
lines((emis_brown_20), col= "red", lwd= 2);
lines((emis_brown_30), col= "blue", lwd= 2);
lines((emis_brown_40), col= "purple4", lwd= 2);
lines((emis_brown), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()
```
...
par(mfrow=c(1,2))
plot((cons_green_10), col= "black", xlab= "Year", ylab= "Level", main= "Consumption ROW", ylim= c(0,150), lwd= 2);
lines((cons_green_20), col= "red", lwd= 2);
lines((cons_green_30), col= "blue", lwd= 2);
lines((cons_green_40), col= "purple4", lwd= 2);
lines((cons_ob*(1-cons_ob_dk_s)), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()


plot((cons_brown_10), col= "black", xlab= "Year", ylab= "Level", main= "Consumption DK", lwd= 2);
lines((cons_brown_20), col= "red", lwd= 2);
lines((cons_brown_30), col= "blue", lwd= 2);
lines((cons_brown_40), col= "purple4", lwd= 2);
lines((cons_ob*cons_ob_dk_s), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()
```
...
par(mfrow=c(1,2))
plot((k_green_10), col= "black", xlab= "Year", ylab= "Level", main= "Capital ROW", ylim= c(0,200), lwd= 2);
lines((k_green_20), col= "red", lwd= 2);
lines((k_green_30), col= "blue", lwd= 2);
lines((k_green_40), col= "purple4", lwd= 2);
lines((k_green), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()

plot((k_brown_10), col= "black", xlab= "Year", ylab= "Level", main= "Capital DK", ylim=c(0,1.6), lwd= 2);
lines((k_brown_20), col= "red", lwd= 2);
lines((k_brown_30), col= "blue", lwd= 2);
lines((k_brown_40), col= "purple4", lwd= 2);
lines((k_brown), col= "green", lwd= 2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()
```
...
par(mfrow=c(1,2))
plot((inv_green_10), col= "black", xlab= "Year", ylab= "Level", main= "Investment ROW", ylim= c(0,40), lwd=2);
lines((inv_green_20), col= "red", lwd=2);
lines((inv_green_30), col= "blue", lwd=2);
lines((inv_green_40), col= "purple4", lwd=2);
lines((inv_green), col= "green", lwd=2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()

plot((inv_brown_10), col= "black", xlab= "Year", ylab= "Level", main= "Investment DK", ylim=c(0,0.3), lwd=2);
lines((inv_brown_20), col= "red", lwd=2);
lines((inv_brown_30), col= "blue", lwd=2);
lines((inv_brown_40), col= "purple4", lwd=2);
lines((inv_brown), col= "green", lwd=2);
legend("left", legend=c("Baseline 1", "Baseline 2","Baseline 3", "Baseline 4", "Real data"),
       lty=c(1),lwd=c(2),bty="n", col = c("black", "red","blue", "purple4","green"));
grid()
```
...
plot((y_brown_11 - y_brown_10)/y_brown_10*100, col= "Black", xlab= "Year", ylab= "% change in GDP from baseline Denmark", main= "Change in GDP Denmark", ylim= c(-0.1,1.5), lwd= 2);
...
plot((y_green_11- y_green_10)/y_green_10*100, col= "Black", xlab= "Year", ylab= "% change in GDP from baseline ROW", main= "Change in GDP ROW", ylim=  c(0,0.01), lwd= 2 );
...
plot((eta_brown_11 - eta_brown_10)/eta_brown_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share DK", ylim=c(0,30), lwd= 2);
...
lines((eta_brown_14 - eta_brown_40)/eta_brown_40*100, col= "red", lwd= 2);
legend("left", legend=c("Scenario 1","Scenario 2","Scenario 3", "Scenario 4"),
       lty=c(1),lwd=c(2),bty="n", col = c("Black","green", "blue", "red"));
grid()

plot((eta_green_11- eta_green_10)/eta_green_10*100, col= "Black", xlab= "Year", ylab= "% change in the renewability share", main= "Change in the renewability share ROW", ylim= c(0, 0.075), lwd= 2);
...
lines((eta_green_14 - eta_green_40)/eta_green_30*100, col= "red", lwd= 2);
legend("left", legend=c("Scenario 1","Scenario 2","Scenario 3", "Scenario 4"),
       lty=c(1),lwd=c(2),bty="n", col = c("Black","green","blue", "red"));
grid()

plot((emis_brown_11-emis_brown_10)/emis_brown_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission Denmark", ylim= c(-30,1), lwd= 2);
...
lines((emis_brown_14-emis_brown_40)/emis_brown_40*100, col= "red", lwd= 2);
legend("left", legend=c("Scenario 1","Scenario 2", "Scenario 3", "Scenario 4"),
       lty=c(1),lwd=c(2),bty="n", col = c("Black","green","blue", "red"));
grid()


plot((emis_green_11-emis_green_10)/emis_green_10*100, col= "Black", xlab= "Year", ylab= "% change in Emission", main= " Emission ROW", ylim= c(-0.06,0.01), lwd= 2);
...
lines((emis_green_14-emis_green_40)/emis_green_40*100, col= "red", lwd= 2);
legend("left", legend=c("Scenario 1","Scenario 2", "Scenario 3", "Scenario 4"),
       lty=c(1),lwd=c(2),bty="n", col = c("Black","green","blue", "red"));
grid()
